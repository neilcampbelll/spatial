...
# see https://github.com/nielshintzen/vmstools/releases/ -> downloads ->Exchange_EFLALO2_v2-1.doc for an example
  ...
  colnames(eflalo)[c(11,15)] <- c("FT_DTIME", "FT_LTIME")
...
# 2.2 Take only VMS pings in the ICES areas ==============================================
  ...
  eflalo$LE_RECT <- substr(eflalo$LE_RECT, 2, 5) # picking up extra pair of quotation symbols '' - this strips them out
